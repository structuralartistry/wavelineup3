...
describe "practice_members/new.html.erb" do
  before(:each) do
    assign(:practice_member, stub_model(PracticeMember,
      :new_record? => true,
      :practice_id => 1,
      :name_last => "MyString",
      :name_first => "MyString",
  ...
  it "renders new practice_member form" do
    render

    rendered.should have_selector("form", :action => practice_members_path, :method => "post") do |form|
