(function() {
  describe('Visit', function() {
    ...
    it('should do something', function() {
      ...
      return expect(practice_room.do_something('something')).toEqual('something');
    });
    it('should load and set data from the server', function() {
      var visit;
      return visit = new Visit(json_data_from_server);
    });
    ...
    return it('should instantiate with data', function() {
      var visit;
      visit = new Visit(json_data_from_server);
      return expect(visit.data).toEqual(json_data_from_server);
    });
  });
}).call(this);
